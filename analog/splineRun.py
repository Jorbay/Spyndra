...
#function to move motors from standing to first value. TODO : Implement
...
#Queries to user for motor type (to be edited out)
...
#Robot Movement Command Sequence
spyndraStand()
splineRunner(chassis, tibia, phase, type)
spyndraSit()

#Saving a gait sequence for random gait generator
save = 0
if(type == 1):
